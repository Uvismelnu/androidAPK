...
fun acidobase(bi:Double,co:Double,pH:Double,na:Double,k:Double,cl:Double): String {
    var textAcidoBasico =""
    var acidosisType =""
        ...
        if ((pH < 7.38) && (bi < 21.7) && (co > co2esperadaAcMsup)&&(deltaHco3>deltaCo2)) {
            textAcidoBasico = "acidosis metabolica predominante con acidosis respiratoria CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }
        else  if ((pH < 7.38) && (bi < 21.7) && (co > co2esperadaAcMsup)&&(deltaHco3<deltaCo2)&&(bi<=hCO3esperadaARAsup)&&bi>=hCO3esperadaARAinf) {
            textAcidoBasico = "acidosis respiratoria aguda predominante con acidosis metabolica  CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }
        else  if ((pH < 7.38) && (bi < 21.7) && (co > co2esperadaAcMsup)&&(deltaHco3<deltaCo2)&&(bi<=hCO3esperadaARCsup)&&bi>=hCO3esperadaARCinf) {
            textAcidoBasico = "acidosis respiratoria cronica predominante con acidosis metabolica  CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }
        else  if ((pH < 7.38) && (bi < 21.7) && (co > co2esperadaAcMsup)&&(deltaHco3<deltaCo2)) {
            textAcidoBasico = "acidosis respiratoria predominante con acidosis metabolica CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }

        //valorar ph 7.4
        else if ((pH < 7.38) && (bi < 21.7) && (co < co2esperadaAcMinf)) {
            textAcidoBasico = "acidosis metabolica con alcalosis respiratoria CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }
        //rango del 5%
        else if ((pH < 7.38) && (bi < 21.7) && (co in co2esperadaAcMinf..co2esperadaAcMsup)&&(deltaHco3>deltaCo2)) {
            textAcidoBasico = "acidosis metabolica simple CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }
        else if ((pH > 7.42) && (bi > 26.3) && (co > co2esperadaAlMsup)&&(deltaHco3>deltaCo2)) {
            textAcidoBasico = "Alcalosis metabolica con acidosis respiratoria CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }

        else if ((pH > 7.42) && (bi > 26.3) && (co < co2esperadaAlMinf)&& (deltaHco3<deltaCo2)&&(bi in hCO3esperadaALRAinf..hCO3esperadaALRAsup)) {
            textAcidoBasico = "Alcalosis respiratoria aguda predominante con alcalosis metabolica CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }
        else if ((pH > 7.42) && (bi > 26.3) && (co < co2esperadaAlMinf)&& (deltaHco3<deltaCo2)&&(bi in hCO3esperadaALRCinf..hCO3esperadaALRCsup)) {
            textAcidoBasico = "Alcalosis respiratoria cronica predominante con alcalosis metabolica CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }
        else if ((pH > 7.42) && (bi > 26.3) && (co < co2esperadaAlMinf)&& (deltaHco3>deltaCo2)) {
            textAcidoBasico = "Alcalosis metabolica predominante con alcalosis respiratoria CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }
        else if ((pH > 7.42) && (bi > 26.3) && (co in co2esperadaAlMinf..co2esperadaAlMsup)&&(deltaHco3>deltaCo2)) {
            textAcidoBasico = "Alcalosis metabolica simple CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }
        else if ((pH > 7.42) && (co < 38) && (bi > hCO3esperadaALRAsup)&&(deltaCo2>deltaHco3)) {

            textAcidoBasico="alcalosis respiratoria aguda predominante con alcalosis metabolica asociada HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)
        }
        else if((pH > 7.42) && (co < 38) && (bi < hCO3esperadaALRCinf)&& (deltaCo2>deltaHco3)){
            textAcidoBasico="alcalosis respiratoria cronica con acidosis metabolica asociada  HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)
            ...
            textAcidoBasico="1-alteracion respiratoria pura con componente agudo y cronico.\n" +
                    ...
                    "3-alcalosis respiratoria cronica con una alcalosis metabolica aguda sobreagregada. HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)
        }

        else if((pH > 7.42) && (co < 38) && (bi in hCO3esperadaALRAinf..hCO3esperadaALRAsup)&&(deltaCo2>deltaHco3)){
            textAcidoBasico="alcalosis respiratoria aguda simple HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)
        }
        else if((pH > 7.42) && (co < 38) && (bi in hCO3esperadaALRCinf..hCO3esperadaALRCsup)&&(deltaCo2>deltaHco3)){
            textAcidoBasico="alcalosis respiratoria cronica simple HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)
        }
        else if ((pH < 7.38) && (co > 42) && (bi < hCO3esperadaARAinf)&&(deltaCo2>deltaHco3)) {

            textAcidoBasico="acidosis respiratoria aguda con acidosis metabolica asociada HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)
        }
        else if((pH < 7.38) && (co > 42) && (bi > hCO3esperadaARCsup)&&(deltaCo2>deltaHco3)){
            textAcidoBasico="acidosis respiratoria cronica con alcalosis metabolica asociada HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)

        }
        else if((pH < 7.38) && (co > 42) && (bi in hCO3esperadaARAinf..hCO3esperadaARCsup)){
            textAcidoBasico="1-alteracion respiratoria pura con componente agudo y cronico (EPOC [enfermedad pulmonar obstructiva cronica] \n" +
                    ...
                    "3-acidosis respiratoria aguda con una alcalosis metabolica asociada (combinacion poco probable) HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)
        }
        else if((pH < 7.38) && (co > 42)&&(bi in hCO3esperadaARCinf..hCO3esperadaARCsup)&&(deltaCo2>deltaHco3)){
            textAcidoBasico="acidosis respiratoria cronica simple HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)

        }
        else if((pH < 7.38) && (co > 42)&&(bi in hCO3esperadaARAinf..hCO3esperadaARAsup)&&(deltaCo2>deltaHco3)){
            textAcidoBasico="acidosis respiratoria aguda simple HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)
            ...
            textAcidoBasico="Acidosis respiratoria aguda predominante con acidosis metabolica HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)

        }
        else if ((pH < 7.38) && (co > 42)  && (bi < 21.7) && (deltaCo2>deltaHco3)&&(bi in hCO3esperadaARCinf..hCO3esperadaARCsup)) {
            textAcidoBasico="Acidosis respiratoria cronica predominante con acidosis metabolica HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)

        }

        else if ((pH < 7.38) && (co > 42)  && (bi < 21.7) && (deltaCo2>deltaHco3)) {
            textAcidoBasico="Acidosis respiratoria predominante con acidosis metabolica HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)

        }
        else if ((pH < 7.38) && (co > 42) &&  (bi < 21.7) && (deltaCo2<deltaHco3)) {
            textAcidoBasico="acidosis metabolica predominante con acidosis respiratoria HCO3=%.2f".format(co2calculado)+"\npH=%.2f".format(phcalculado)

        }
        else if ((pH < 7.38) && (co > 42)  && (bi < 21.7) && (deltaCo2 ==deltaHco3)) {
            textAcidoBasico="acidosis metabolica con acidosis respiratoria(ambas de igual valor) HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)

        }
        else if ((pH < 7.38) && (co > 42)&&(bi in 21.7..26.3)) {
            textAcidoBasico="acidosis respiratoria no compensada HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)

        }
        else if ((pH < 7.38) && (bi< 21.7)&&(co in 38.0..42.0)) {
            textAcidoBasico="acidosis metabolica no compensada HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)

        }

        else if((pH > 7.42) && (co < 38) && (bi > 26.3) && (deltaCo2 > deltaHco3)&&((bi in hCO3esperadaALRAinf..hCO3esperadaALRAsup))){
            textAcidoBasico="Alcalosis respiratoria aguda predominante con alcalosis metabolica HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)

        }
        else if((pH > 7.42) && (co < 38) && (bi > 26.3) && (deltaCo2 > deltaHco3)&&((bi in hCO3esperadaALRCinf..hCO3esperadaALRCsup))){
            textAcidoBasico="Alcalosis respiratoria cronica predominante con alcalosis metabolica HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)

        }
        else if((pH > 7.42) && (co < 38) && (bi > 26.3) && (deltaCo2 > deltaHco3)){
            textAcidoBasico="Alcalosis respiratoria predominante con alcalosis metabolica HCO3=%.2f".format(hco3calculado)+"\npH=%.2f".format(phcalculado)

        }
        else if ((pH > 7.42) && (bi > 26.3) && (co < co2esperadaAlMinf)&& (deltaHco3<deltaCo2)) {
            textAcidoBasico = "Alcalosis respiratoria predominante con alcalosis metabolica CO2=%.2f".format(co2calculado)+ "\npH=%.2f".format(phcalculado)
        }
            ...
            textAcidoBasico="Alcalosis metabolica no compensada CO2=%.2f".format(co2calculado)+"\npH=%.2f".format(phcalculado)

        }
        else if((pH > 7.42) && (co< 38.0) && (bi in 21.7..26.3)){
            textAcidoBasico="Alcalosis respiratoria no compensada CO2=%.2f".format(co2calculado)+"\npH=%.2f".format(phcalculado)
    ...
    val textResult = textAcidoBasico + acidosisType
