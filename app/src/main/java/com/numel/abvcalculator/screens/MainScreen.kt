        ...
        if (viewModel.isScreenCO2100_160_H_0_100Visible || viewModel.isScreenCO2100_160_H_100_160Visible || viewModel.isScreenCO2_0_100_h100_160Visible) {
            ...
            when {
                viewModel.isScreenCO2100_160_H_0_100Visible -> {
                    // En la sección donde se llama a CartesianGraghCO2100_160_H0_100
                    CartesianGraghCO2100_160_H0_100(
                        modifier = Modifier.size(canvasDp),
                        labelInterval = 10f,
                        lines = listOf(
                            Pair(Pair(100f, 99.291f), Pair(100.7f, 100f)),
                            Pair(Pair(100f, 88.259f), Pair(113.30f, 100f)),
                            Pair(Pair(100f, 79.433f), Pair(125.89f, 100f)),
                            Pair(Pair(100f, 72.212f), Pair(138.48f, 100f)),
                            Pair(Pair(100f, 66.194f), Pair(151.07f, 100f)),
                            Pair(Pair(100f, 61.102f), Pair(160f, 97.76f)),
                            Pair(Pair(100f, 56.738f), Pair(160f, 90.78f)),
                            Pair(Pair(100f, 52.955f), Pair(160f, 84.73f)),
                            Pair(Pair(100f, 49.646f), Pair(160f, 79.43f)),
                            Pair(Pair(100f, 46.725f), Pair(160f, 74.76f)),
                            Pair(Pair(100f, 44.129f), Pair(160f, 70.61f)),
                            Pair(Pair(100f, 41.807f), Pair(160f, 66.89f)),
                            Pair(Pair(100f, 39.716f), Pair(160f, 63.55f)),
                            Pair(Pair(100f, 37.825f), Pair(160f, 60.52f)),
                            Pair(Pair(100f, 36.106f), Pair(160f, 57.77f)),
                            Pair(Pair(100f, 34.536f), Pair(160f, 55.26f)),
                            Pair(Pair(100f, 33.097f), Pair(160f, 52.96f)),
                            Pair(Pair(100f, 31.773f), Pair(160f, 50.84f))
                        ),
                        currentPH = pH,
                        currentCO2 = co2,
                        phAxisLabelFontSize = 14.dp,
                        referenceLabels = listOf(
                            // Ajustar las coordenadas Y para que estén entre 0-100
                            ReferenceLabelInfo("21", 100f, 95f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("24", 110f, 95f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("27", 122f, 95f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("30", 133f, 95f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("33", 146f, 95f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("36", 155f, 93.68f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("39", 155f, 87.57f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("42", 155f, 81.78f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("45", 155f, 76.26f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("48", 155f, 71.5f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("51", 155f, 67f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("54", 155f, 64f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("57", 155f, 61f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("60", 155f, 58f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("63", 155f, 55f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("66", 155f, 52f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("69", 155f, 49.5f, 9.dp, android.graphics.Color.BLACK),
                            ReferenceLabelInfo("72", 155f, 47.17f, 9.dp, android.graphics.Color.BLACK)
                        )
                    )
                }
