...
import com.numel.abvcalculator.data.classifyPaCO2
...
fun ClassifyPaCO2(
    ...
    Column(
        ...
        Button(
            onClick = {
                val po2Value = txCO2arterial.toDoubleOrNull()
                if (po2Value != null) {
                    viewModel.updateTxCO2arterial(classifyPaCO2(po2Value)) // Update the ViewModel with the first TextField's value
